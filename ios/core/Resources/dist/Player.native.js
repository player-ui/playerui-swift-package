        ...
        _create_class(Resolver, [
            ...
            },
            {
                ...
                value: function cloneNode(node) {
                    var clonedNode = (0, import_timm5.clone)(node);
                ...
                value: function computeTree(node, rawParent, dataChanges, cacheUpdate, options, partiallyResolvedParent, prevASTMap) {
                    ...
                    if ("children" in resolvedAST) {
                        ...
                        var newChildren = (_resolvedAST_children = resolvedAST.children) === null || _resolvedAST_children === void 0 ? void 0 : _resolvedAST_children.map(function(child) {
                            ...
                            if (childValue) {
                                if (childNode.type === "template" /* Template */ ) {
                                    if (childNode.placement === "append") {
                                        var arr = (0, import_timm5.addLast)(dlv_es_default(resolved, child.path, []), childValue);
                                        resolved = (0, import_timm5.setIn)(resolved, child.path, arr);
                                    } else if (childNode.placement === "prepend") {
                                        var arr1 = (0, import_timm5.addFirst)(dlv_es_default(resolved, child.path, []), childValue);
                                        resolved = (0, import_timm5.setIn)(resolved, child.path, arr1);
                                    }
                                }
                                if (childNode.type === "multi-node" /* MultiNode */  && !childNode.override) {
                                    var arr2 = (0, import_timm5.addLast)(dlv_es_default(resolved, child.path, []), childValue);
                                    resolved = (0, import_timm5.setIn)(resolved, child.path, arr2);
                                } else {
            ...
            },
            {
                ...
                value: function applyParser(parser) {
                    ...
                    function getTemplateSymbolValue(node) {
                        if (node.type === "multi-node" /* MultiNode */ ) {
                            return node[templateSymbol];
                        } else if (node.type === "template" /* Template */ ) {

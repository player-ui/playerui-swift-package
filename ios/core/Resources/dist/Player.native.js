...
var Player = function() {
    ...
    __export(src_exports, {
        ...
        ERROR_BINDING_PREFIX: function() {
            return ERROR_BINDING_PREFIX;
        },
        ...
        function getValueForNode(node) {
            ...
            if (node.name === "PathNode") {
                ...
                try {
                    ...
                    throw new import_ts_nested_error.NestedError("Unable to resolve path segment: ".concat(nestedResolvedValue.path), e);
                }
            }
            if (node.name === "Expression") {
                try {
                    ...
                    throw new import_ts_nested_error.NestedError("Unable to resolve path: ".concat(node.value), e);
                }
            }
    ...
    function findClosestNodeAtPosition(node, position) {
        switch(node.type){
            ...
            case "BinaryExpression":
                {
                    var _findClosestNodeAtPosition;
                    var check = (_findClosestNodeAtPosition = findClosestNodeAtPosition(node.left, position)) !== null && _findClosestNodeAtPosition !== void 0 ? _findClosestNodeAtPosition : findClosestNodeAtPosition(node.right, position);
                    if (check) {
                        return check;
                    }
                    break;
            ...
            case "UnaryExpression":
                {
                    var checkArg = findClosestNodeAtPosition(node.argument, position);
                    if (checkArg) {
                        return checkArg;
                    }
                    break;
            ...
            case "MemberExpression":
                {
                    var _findClosestNodeAtPosition1;
                    var checkObject = (_findClosestNodeAtPosition1 = findClosestNodeAtPosition(node.object, position)) !== null && _findClosestNodeAtPosition1 !== void 0 ? _findClosestNodeAtPosition1 : findClosestNodeAtPosition(node.property, position);
                    if (checkObject) {
                        return checkObject;
                    }
                    break;
            ...
            case "Compound":
                {
                    var elements = node.type === "ArrayExpression" ? node.elements : node.body;
                    var anyElements = elements.find(function(e) {
                        return findClosestNodeAtPosition(e, position);
                    });
                    if (anyElements) {
                        return anyElements;
                    }
            ...
            case "Object":
                {
                    var checkObject2 = node.attributes.reduce(function(found, next) {
                        var _ref;
                        return (_ref = found !== null && found !== void 0 ? found : findClosestNodeAtPosition(next.key, position)) !== null && _ref !== void 0 ? _ref : findClosestNodeAtPosition(next.value, position);
                    }, void 0);
                    if (checkObject2) {
                        return checkObject2;
                    }
            ...
            case "CallExpression":
                {
                    var _node_args_find;
                    var anyArgs = (_node_args_find = node.args.find(function(arg) {
                        return findClosestNodeAtPosition(arg, position);
                    })) !== null && _node_args_find !== void 0 ? _node_args_find : findClosestNodeAtPosition(node.callTarget, position);
                    if (anyArgs) {
                        return anyArgs;
                    }
                    break;
    ...
    var ConsoleLogger = /*#__PURE__*/ function() {
        function ConsoleLogger() {
            ...
            _class_call_check(this, ConsoleLogger);
        ...
        _create_class(ConsoleLogger, [
            ...
            {
                key: "getConsoleFn",
                value: function getConsoleFn(severity) {
            ...
            },
            {
                ...
                value: function createHandler(severity) {
                    ...
                    return function() {
                        ...
                        var sevIndex = severities.indexOf(severity);
                        var sevConf = severities.indexOf(_this.severity);
                        if (sevIndex >= sevConf) {
                            _this.getConsoleFn(severity).apply(_this, [
                                "player - ".concat(severity, " -")
                            ].concat(_to_consumable_array(args)));
                        }
                    };
                }
        ...
        _create_class(Parser, [
            {
                ...
                value: function parseView(value) {
                    var viewNode = this.parseObject(value, "view" /* View */ );
                    if (!viewNode) {
            ...
            },
            {
                ...
                value: function parseObject(obj) {
                    var type = arguments.length > 1 && arguments[1] !== void 0 /* Value */  ? arguments[1] : "value", options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {
                        templateDepth: 0
                    };
                    var _this = this;
    ...
    var ResolverStage = /* @__PURE__ */ function(ResolverStage2) {
            ...
            },
            {
                ...
                value: function runApplicableValidations(runner, canDismiss, phase) {
                    ...
                    this.applicableValidations = this.applicableValidations.map(function(originalValue) {
                        ...
                        var obj = (0, import_timm5.setIn)(originalValue, [
                            "value",
                            "blocking"
                        ], blocking);
        ...
        _create_class(Resolver, [
            ...
            },
            {
                ...
                value: function cloneNode(node) {
                    var clonedNode = (0, import_timm6.clone)(node);
                        ...
                        var newChildren = (_resolvedAST_children = resolvedAST.children) === null || _resolvedAST_children === void 0 ? void 0 : _resolvedAST_children.map(function(child) {
                            ...
                            if (childValue) {
                                if (childNode.type === "multi-node" /* MultiNode */  && !childNode.override) {
                                    var arr = (0, import_timm6.addLast)(dlv_es_default(resolved, child.path, []), childValue);
                                    resolved = (0, import_timm6.setIn)(resolved, child.path, arr);
                                } else {
                                    resolved = (0, import_timm6.setIn)(resolved, child.path, childValue);
                                }
                            }
        ...
        _create_class(TemplatePlugin, [
            {
                ...
                value: function parseTemplate(parseObject, node, options) {
                    ...
                    data.forEach(function(dataItem, index) {
                        ...
                        var parsed = parseObject(JSON.parse(templateStr), "value" /* Value */ , {
                ...
                value: function applyResolver(resolver) {
                    ...
                    resolver.hooks.resolve.tap("string-resolver", function(value, node, options) {
                        ...
                        if (node.type === "value" /* Value */  || node.type === "asset" /* Asset */  || node.type === "view" /* View */ ) {
                            ...
                            } else if (((_node_parent = node.parent) === null || _node_parent === void 0 ? void 0 : _node_parent.type) === "multi-node" /* MultiNode */  && (((_node_parent1 = node.parent) === null || _node_parent1 === void 0 ? void 0 : (_node_parent_parent = _node_parent1.parent) === null || _node_parent_parent === void 0 ? void 0 : _node_parent_parent.type) === "asset" /* Asset */  || ((_node_parent2 = node.parent) === null || _node_parent2 === void 0 ? void 0 : (_node_parent_parent1 = _node_parent2.parent) === null || _node_parent_parent1 === void 0 ? void 0 : _node_parent_parent1.type) === "view" /* View */ ) && ((_node_parent_parent_value = node.parent.parent.value) === null || _node_parent_parent_value === void 0 ? void 0 : _node_parent_parent_value.id) && _this.propertiesToSkipCache.has(node.parent.parent.value.id)) {
            ...
            },
            {
                ...
                value: function applyResolver(resolver) {
                    resolver.hooks.beforeResolve.tap("applicability", function(node, options) {
                        var newNode = node;
                        if ((node === null || node === void 0 ? void 0 : node.type) === "applicability" /* Applicability */ ) {
    ...
    // ../../../../../../../../../../execroot/_main/bazel-out/k8-fastbuild/bin/core/player/src/player.ts
    var PLAYER_VERSION = true ? "0.15.5--canary.888.37918" : "unknown";
    var COMMIT = true ? "dd026fa087aea86b3a07e5f8f0e1d1849d564627" : "unknown";
    var _Player = /*#__PURE__*/ function() {
        function _Player(config) {
            var _this = this;
            _class_call_check(this, _Player);

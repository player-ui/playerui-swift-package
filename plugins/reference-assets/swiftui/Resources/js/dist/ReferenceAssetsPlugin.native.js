                ...
                value: function applyResolver(resolver, context) {
                    ...
                    resolver.hooks.beforeResolve.tap(this.name, function(node, options) {
                        ...
                        if (resolvedNode !== void 0) {
                            ...
                            var existingResolvedNodes = (_node_asyncNodesResolved = node.asyncNodesResolved) !== null && _node_asyncNodesResolved !== void 0 ? _node_asyncNodesResolved : [];
                            resolvedNode.asyncNodesResolved = _to_consumable_array(existingResolvedNodes).concat([
                                node.id
                            ]);

     ...
     */ key: "handleAsyncUpdate",
                value: function handleAsyncUpdate(node, context, newNode) {
                    ...
                    if (nodeResolveCache.get(node.id) !== newNode) {
                        ...
                        var originalNode = (_originalNodeCache_get = originalNodeCache.get(node.id)) !== null && _originalNodeCache_get !== void 0 ? _originalNodeCache_get : node;
                        viewController.updateViewAST(/* @__PURE__ */ new Set([
                            originalNode
                        ]));
                    }
                }

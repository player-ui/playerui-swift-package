                            ...
                            if (value && value.state_type === "ASYNC_ACTION") {
                                ...
                                try {
                                    ...
                                    if (isPromiseLike(result)) {
                                        if (value.await) {
                                            queueMicrotask(/*#__PURE__*/ _async_to_generator(function() {
                                                var _tmp, _, e;
                                                return _ts_generator(this, function(_state) {
                                                    switch(_state.label){
                                                        case 0:
                                                            ...
                                                            if (!(flowController === null || flowController === void 0)) return [
                                                                3,
                                                                1
                                                            ];
                                                            _tmp = void 0;
                                                        ...
                                                        case 1:
                                                            _ = flowController.transition;
                                                            return [
                                                                4,
                                                                result
                                                            ];
                                                        case 2:
                                                            _tmp = _.apply(flowController, [
                                                                String.apply(void 0, [
                                                                    _state.sent()
                                                                ])
                                                            ]);
